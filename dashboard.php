    ...
    <div class="row g-3 mb-4">
        <div class="col-12 col-md-4">
            <div class="card card-custom p-3">
                ...
                <b id="sumIncome" class="text-success h5 mb-0">Rp 0</b>
            </div>
        </div>
        <div class="col-12 col-md-4">
            <div class="card card-custom p-3">
                <small class="text-muted d-block mb-1">Total Pengeluaran</small>
                <b id="sumExpense" class="text-danger h5 mb-0">Rp 0</b>
            </div>
        </div>
        <div class="col-12 col-md-4">
            <div class="card card-custom p-3">
                <small class="text-muted d-block mb-1">Sisa Saldo Kelola</small>
                <b id="sumSaldo" class="text-white h5 mb-0">Rp 0</b>
            </div>
        </div>
    </div>
    ...
    <div class="card card-custom p-3">
        <div class="table-responsive">
            <table class="table table-custom align-middle mb-0 text-nowrap">
                ...
                <tbody id="trxTable">
                    <tr><td colspan="4" class="text-center text-muted py-3">Memuat riwayat transaksi...</td></tr>
                </tbody>
            </table>
        </div>
    </div>
